...
[![NPM Package](https://img.shields.io/npm/v/@regenerative-finance/v2-deployments.svg)](https://www.npmjs.org/package/@regenerative-finance/v2-deployments)
[![GitHub Repository](https://img.shields.io/badge/github-deployments-lightgrey?logo=github)](https://github.com/regenerative-finance/regenerative-finance-v2-monorepo/tree/master/pkg/deployments)

This package contains the addresses and ABIs of all Regenerative Finance V2 deployed contracts, a fork of Balancer V2. Each deployment consists of a deployment script (called 'task'), inputs (script configuration, such as dependencies), outputs (typically contract addresses), ABIs and bytecode files of related contracts.

Addresses and ABIs can be consumed from the package in JavaScript environments, or manually retrieved from the [GitHub](https://github.com/regenerative-finance/regenerative-finance-v2-monorepo/tree/master/pkg/deployments) repository.
...
```console
$ npm install @regenerative-finance/v2-deployments
```

### Usage

Import `@regenerative-finance/v2-deployments` to access the different ABIs and deployed addresses. To see all current Task IDs and their associated contracts, head to [Active Deployments](#active-deployments).
